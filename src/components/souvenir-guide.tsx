...
const SOUVENIR_DATA: SouvenirItem[] = [
  {
    ...
    emoji: "🌸",
    description:
      "Hand-picked saffron strands from Pampore fields. Extremely rich aroma and deep coloring property.",
    ...
    driverTip:
      "Aalim says: Buy directly from farmers at Pampore while on the way to Pahalgam, rather than tourist hubs.",
    warning:
      "Avoid extremely cheap saffron sold in plastic boxes by street vendors — it is usually dyed corn silk.",
  },
  {
    id: "pashmina",
    ...
    emoji: "🧣",
    description:
      "Authentic Cashmere wool spun from the soft undercoat of Changthangi goats. Pure warmth and luxury.",
    ...
    driverTip:
      "Umair says: Pure pashmina has irregular handloom weave margins. Avoid sellers claiming 100% pure pashmina for ₹1,500.",
    warning:
      "Machines spin mixed poly-wool ('semi-pashmina') which looks identical but has no warmth. Always check weave irregularities.",
  },
  {
    id: "walnut-wood",
    ...
    emoji: "🪵",
    description:
      "Carved from solid walnut trees native to Kashmir. Highly durable furniture, bowls, and showpieces.",
    ...
    driverTip:
      "Aalim says: Check the underside of boxes. Cheap pine/board wood is often stained brown to mimic walnut.",
    warning:
      "Look out for composite MDF wood covered in thin walnut veneers which will warp in humid climates.",
  },
  {
    id: "dry-fruits",
    ...
    emoji: "🌰",
    description:
      "Mamra almonds (high oil content) and paper-shell walnuts (Kagzi) that crack open easily by hand.",
    ...
    driverTip:
      "Umair says: Buy nuts in shell. Shelled kernels lose their natural oils and flavor within weeks.",
    warning:
      "Avoid pre-packaged bags in heavily touristed bus stops where lower grade imported nuts are mixed in.",
  },
];
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h3 className="text-xl font-bold text-foreground">
            Kashmiri Souvenirs &amp; Anti-Scam Guide
          </h3>
          <p className="text-sm text-muted-foreground">
            Vetted by Aalim &amp; Umair. Learn how to verify authentic local products and check fair
            prices.
          </p>
        </div>
      </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p
                      className={`text-[10px] truncate ${isSelected ? "text-primary-foreground/85" : "text-muted-foreground"}`}
                    >
                      {item.priceRange}
                    </p>
                  </div>
            ...
            <div className="rounded-xl border border-border/60 bg-white dark:bg-card p-4 space-y-3">
              <div className="flex items-center gap-2 text-primary">
                ...
                <span className="text-xs font-bold uppercase tracking-wider">
                  How to test: {currentItem.testMethodName}
                </span>
              </div>
