...
const mockPosts: InstaPost[] = [
  ...
  },
  {
    id: "post2",
    type: "image",
    caption: "POV: Quiet pine forests and fresh mountain water streams. Join us on our outstation trips. 🌲",
    likes: 198,
    comments: 18,
  ...
  },
  {
    id: "post3",
    type: "reel",
    caption: "'The best driver companions! Took beautiful photos and guided us honestly.' Thank you guests! 🚣",
    likes: 312,
    comments: 45,
