    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-2.5 bg-panel p-4 rounded-xl border border-border/50 text-xs text-muted-foreground">
        ...
        <p className="leading-relaxed">
          * Standard Union Prices are base estimations for the Maruti Suzuki Dzire sedan (capacity:
          4 guests). Rates exclude overnight halts, driver night allowance, toll taxes, and local
