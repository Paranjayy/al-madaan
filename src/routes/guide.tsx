...
function GuidePage() {
  ...
  return (
    <SiteLayout>
      ...
      {/* Taxi Unions & Local Quirks Section */}
      <section className="mx-auto w-full max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="rounded-2xl border border-border/80 bg-panel/30 p-6 sm:p-10 space-y-8">
          <div className="space-y-2">
            <p className="section-kicker">Important: Transparency First</p>
            <h2 className="text-3xl font-bold text-foreground">Kashmir Taxi Union Rules & Local Quirks</h2>
            <p className="text-sm text-muted-foreground">
              Kashmir travel has unique local guidelines set by taxi unions and town authorities. Here's exactly how it works so you don't face surprises.
            </p>
          </div>

          <div className="grid gap-6 md:grid-cols-2">
            {/* Rule 1 */}
            <article className="surface-card p-5 space-y-3 bg-card">
              <div className="flex items-center gap-2">
                <span className="text-xl">🚕</span>
                <h3 className="font-bold text-foreground text-sm">The Srinagar vs. Local Valley Union Rule</h3>
              </div>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Srinagar cabs (like our vehicles) are permitted to drive you to all towns and drop you off at your hotels. However, local taxi unions in **Pahalgam**, **Gulmarg**, and **Sonmarg** do not allow outside cabs to do local sightseeing.
              </p>
              <p className="text-xs font-semibold text-primary">
                💡 Traveler POV: You must hire a local union-registered taxi or horses to visit Aru/Betaab Valleys in Pahalgam or Zero Point in Sonmarg.
              </p>
            </article>
            ...
            <article className="surface-card p-5 space-y-3 bg-card">
              <div className="flex items-center gap-2">
                <span className="text-xl">📶</span>
                <h3 className="font-bold text-foreground text-sm">Prepaid SIM Card Deactivation</h3>
              </div>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Due to local security policies, mobile prepaid SIM cards registered outside of Jammu and Kashmir will not catch network coverage. Only postpaid connection lines work.
              </p>
              <p className="text-xs font-semibold text-primary">
                💡 Traveler POV: Ensure at least one member in your family has a postpaid BSNL, Jio, or Airtel SIM before starting the flight.
              </p>
            </article>
            ...
            <article className="surface-card p-5 space-y-3 bg-card">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-foreground text-sm">Winter Snow Chains at Tangmarg</h3>
              </div>
              <p className="text-xs text-muted-foreground leading-relaxed">
                During heavy snowfall, road police block standard cars from driving up from Tangmarg to Gulmarg without metal tyre chains for grip on active sheet ice.
              </p>
              <p className="text-xs font-semibold text-primary">
                💡 Driver POV: Drivers must stop at Tangmarg to rent and fit chains (charge of ₹500–₹1,000). A good driver companion coordinates this.
              </p>
            </article>
            ...
            <article className="surface-card p-5 space-y-3 bg-card">
              <div className="flex items-center gap-2">
                <span className="text-xl">💵</span>
                <h3 className="font-bold text-foreground text-sm">UPI/GPay Mountain Blackouts</h3>
              </div>
              <p className="text-xs text-muted-foreground leading-relaxed">
                While Srinagar has strong mobile internet, high mountain passes like Zoji La (Sonmarg), Razdan Pass (Gurez), and Sinthan Top have zero data coverage.
              </p>
              <p className="text-xs font-semibold text-primary">
                💡 Traveler POV: Keep hard cash (INR) handy to pay for tea, horse rides, or local purchases in remote valleys.
              </p>
            </article>
          </div>
        </div>
