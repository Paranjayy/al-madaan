...
export const destinations: Destination[] = [
  ...
  },
  {
    slug: "gurez",
    name: "Gurez Valley",
    tagline: "The Last Borderland",
    image: "/images/destinations/gurez.jpg",
    ...
    lng: 74.8389,
    activities: [
      "Walk along the roaring Kishenganga River.",
      "Visit the historic border town of Dawar and speak with friendly locals.",
      "Watch the golden sunset illuminate the peak of Habba Khatoon.",
    ],
    badge: "Offbeat Gem",
  },
  {
    slug: "sinthan-top",
    name: "Sinthan Top",
    tagline: "360° Alpine Viewpoint",
    image: "/images/destinations/sinthantop.jpg",
    ...
    lng: 75.4981,
    activities: [
      "Play in the snow at the summit, even in early summer.",
      "Capture stunning wide-angle photos of the winding mountain curves.",
      "Stop at Kokernag botanical gardens on the drive back.",
    ],
    badge: "Hidden Gem",
  },
  {
    slug: "lolab",
    name: "Lolab Valley",
    tagline: "Land of Orchards and Springs",
    image: "/images/destinations/lolab.jpg",
    ...
    priceMin: 3800,
    priceMax: 4200,
    highlights: ["Kalaroos Caves", "Sogam Village", "Lush Fruit Orchards", "Pristine Springs"],
    ...
    activities: [
      ...
      "Enjoy traditional Kashmiri hospitality in a rural village environment.",
    ],
    badge: "Offbeat Gem",
  },
  {
    slug: "bangus",
    name: "Bangus Valley",
    tagline: "The Virgin Meadows",
    image: "/images/destinations/bangus.jpg",
    distance: "128 km from Srinagar",
    distanceKm: 128,
    time: "~4.5 hrs drive",
    season: "May – Sep",
    seasonShort: "May – Sep",
    ...
    lng: 74.0784,
    activities: [
      "Camp under a starry sky in the pristine Chota Bangus grasslands.",
      "Cross wooden footbridges over the crystal-clear Mawri stream.",
      "Trek along pine-forested ridges for panoramic border views.",
    ],
    badge: "Hidden Gem",
  },
];
